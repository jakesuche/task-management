...
<template>
  <transition-group name="toast"
    tag="div" class="fixed top-2 right-5 flex flex-col gap-4 z-50 w-full max-w-[300px]">
    <div
      v-for="toast in toasts"
      :key="toast.id"
      :class="['p-3 rounded-lg shadow-lg flex items-center justify-between ', getSeverityClass(toast.severity)]"
    >
      <div>
